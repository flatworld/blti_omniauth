...
Gem::Specification.new do |s|
  s.name = "blti_omniauth"
  s.version = "0.1.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Xavi Aracil"]
  s.date = "2013-03-01"
  s.description = "Omniauth strategy for blti consumers"
  s.email = "xaracil@uoc.edu"
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  ...
  s.homepage = "http://github.com/xaracil/blti_omniauth"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.11"
  s.summary = "Omniauth strategy for blti consumers"
